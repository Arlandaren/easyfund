...
type TransactionService interface {
	GetUserTransactionHistory(ctx context.Context, userID int64) (*models.TransactionHistoryDTO, error)
	GetBankTransactionHistory(ctx context.Context, userID int64, bankID int16) ([]models.Transaction, error)
...
func (s *transactionServiceImpl) GetUserTransactionHistory(ctx context.Context, userID int64) (*models.TransactionHistoryDTO, error) {
...
func (s *transactionServiceImpl) GetBankTransactionHistory(ctx context.Context, userID int64, bankID int16) ([]models.Transaction, error) {
